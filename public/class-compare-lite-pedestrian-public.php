...
/* 		wp_localize_script(
	...
	public  function compare_lite_shortcode( $atts = [], $content = null, $tag = '') {
		...
		<?php if( $this->is_amp_active() ): ?>
			...
			<div class="amp-cimet-form" style="background-color: #f5f5f5; padding:10px;width: 100%; max-width: 350px;">
				...
				<div class="input-field" style="margin-bottom: 1rem;">
					<amp-autocomplete 
						...
						src="<?php echo esc_url( plugin_dir_url( __DIR__ ) ); ?>public/js/postcodes.json" style="width: 100%; max-width: 350px;"
					>
						<input name="postcode" placeholder="<?php echo esc_attr( $default_atts['placeholder_text'] ); ?>" required style="width: 100%;padding: 20px 15px;border-radius: 0px;">
